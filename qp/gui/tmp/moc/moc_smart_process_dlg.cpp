...
static const char qt_meta_stringdata_Smart_Process_Dlg[] = {
    ...
    ",\0slot_rangeChanged(int,int)\0href\0"
    "slot_linkActivated(QString)\0"
    "on_btn_Close_clicked()\0resInvokeMethod,\0"
    "slot_retResult(bool,QVariant)\0"
    "on_btn_save_to_file_clicked()\0"
    "on_btn_maximizedShow_clicked()\0"
};
...
void Smart_Process_Dlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->slot_rangeChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 3: _t->slot_linkActivated((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        case 6: _t->on_btn_save_to_file_clicked(); break;
        case 7: _t->on_btn_maximizedShow_clicked(); break;
        default: ;
        }
    }
}
...
const QMetaObject Smart_Process_Dlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Smart_Process_Dlg,
