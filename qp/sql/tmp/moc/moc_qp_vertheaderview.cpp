...
#include "../../tableview/qp_vertheaderview.h"
...
static const uint qt_meta_data_QpVertHeaderView[] = {
 ...
 // properties: name, type, flags
     ...
     994,  953, 0x01095103,
    1013,  953, 0x01095103,
    1041, 1037, 0x02095103,
    1060, 1037, 0x02095103,
    1093, 1079, 0x0009510b,

 // enums: name, flags, count, data
    1110, 0x0,    5,  154,

 // enum data: key, value
    1121, uint(QpVertHeaderView::Interactive),
    1133, uint(QpVertHeaderView::Stretch),
    1141, uint(QpVertHeaderView::Fixed),
    1147, uint(QpVertHeaderView::ResizeToContents),
    1164, uint(QpVertHeaderView::Custom),
...
static const char qt_meta_stringdata_QpVertHeaderView[] = {
    ...
    "slot_sectionsTmplChanged()\0index,start,end\0"
    "slot_rowsAboutToBeInserted(QModelIndex,int,int)\0"
...
void QpVertHeaderView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 15: _t->slot_sectionsTmplChanged(); break;
        case 16: _t->slot_rowsAboutToBeInserted((*reinterpret_cast< const QModelIndex(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
