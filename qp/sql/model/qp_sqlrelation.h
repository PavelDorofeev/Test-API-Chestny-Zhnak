...
class LIB_PREFIX_QP_SQL QpSqlRelation
{
public:
    enum JoinMode {
        InnerJoin,
...
public:
    ...
    explicit QpSqlRelation(
            ...
            ,const QString &externalDbName =QString()  // может быть с другой базой связь
            );
    ...
    QString externalDbName;  // может быть с другой базой связь
